  ...
  describe("Enrollment.create", () => {
    ...
    it("should reject a teacher with a section and no course", async () => {
      await expect(
        ...
        "Validation error: A teacher cannot be enrolled at the section level"
      );
    });
    ...
    it("should reject a teacher with no course and no section", async () => {
      await expect(
        ...
        "Validation error: Teacher must be enrolled in a course"
      );
    });
    ...
    it("should reject a non-teacher with a course and no section", async () => {
      await expect(
        ...
        "Validation error: Only a teacher can be enrolled at the course level"
      );
    });
    ...
    it("should reject a non-teacher with no course and no section", async () => {
      await expect(
        ...
        "Validation error: student must be enrolled in a section"
      );
    });
    ...
    it("should reject any role with a course and a section", async () => {
      await expect(
        ...
        "Validation error: Enrollment cannot be in a section and a course"
      );
      await expect(
        db.Enrollment.create({
          role: "student",
