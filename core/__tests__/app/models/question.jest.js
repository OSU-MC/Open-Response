  ...
  describe("Question.create", () => {
    ...
    it("should invalidate the type because it does not exist", async () => {
      await expect(
        ...
        "Validation error: Question type is not a valid option"
      );
    });
    ...
    it("should invalidate because a stem was not provided", async () => {
      await expect(
        ...
        "notNull Violation: Question stem text must be provided"
      );
    });
    ...
    it("should invalidate because the stem provided was empty", async () => {
      await expect(
        ...
        "Validation error: Question stem text must be provided"
      );
    });
    ...
    describe("type: multiple choice", () => {
      ...
      it("should invalidate content because no options were provided", async () => {
        await expect(
          ...
          "Validation error: multiple choice question must have options"
        );
      });
      ...
      it("should invalidate content because not enough options were provided", async () => {
        await expect(
          ...
          "Validation error: multiple choice question must have more than 1 option"
        );
      });
      ...
      it("should invalidate content because options were not indexed properly", async () => {
        await expect(
          ...
          "Validation error: multiple choice question option indexed incorrectly or null"
        );
      });
      ...
      it("should invalidate content because option(s) were empty", async () => {
        await expect(
          ...
          "Validation error: multiple choice question option must have a string or numeric value"
        );
      });
      ...
      it("should invalidate answers because the number of entries does not match content", async () => {
        await expect(
          ...
          "Validation error: multiple choice question must have indication of correctness for each option"
        );
      });
      ...
      it("should invalidate answers because answers were not indexed properly", async () => {
        await expect(
          ...
          "Validation error: multiple choice question answer indexed incorrectly or null"
        );
      });
      ...
      it("should invalidate answers because answers are not boolean type", async () => {
        await expect(
          ...
          "Validation error: multiple choice question answer must have a boolean value"
        );
      });
      ...
      it("should invalidate answers because only 1 answer can be correct", async () => {
        await expect(
          ...
          "Validation error: multiple choice question can only and must have 1 correct answer"
        );
      });
    });
    ...
    describe("type: multiple answer", () => {
      ...
      it("should invalidate content because no options were provided", async () => {
        await expect(
          ...
          "Validation error: multiple answer question must have options"
        );
      });
      ...
      it("should invalidate content because not enough options were provided", async () => {
        await expect(
          ...
          "Validation error: multiple answer question must have more than 1 option"
        );
      });
      ...
      it("should invalidate content because options were not indexed properly", async () => {
        await expect(
          ...
          "Validation error: multiple answer question option indexed incorrectly or null"
        );
      });
      ...
      it("should invalidate content because option(s) were empty", async () => {
        await expect(
          ...
          "Validation error: multiple answer question option must have a string or numeric value"
        );
      });
      ...
      it("should invalidate answers because the number of entries does not match content", async () => {
        await expect(
          ...
          "Validation error: multiple answer question must have indication of correctness for each option"
        );
      });
      ...
      it("should invalidate answers because answers were not indexed properly", async () => {
        await expect(
          ...
          "Validation error: multiple answer question answer indexed incorrectly or null"
        );
      });
      ...
      it("should invalidate answers because answers are not boolean type", async () => {
        await expect(
          ...
          "Validation error: multiple answer question answer must have a boolean value"
        );
      });
      ...
      it("should invalidate answers because there are no correct answers found", async () => {
        await expect(
          ...
          "multiple answer question must have at least 1 correct answer"
        );
      });
    });
  });
