...
describe('/lectureSummaries endpoints', () => {
    ...
    beforeAll(async() => {
        ...
        user5Cookies = [`_openresponse_session=${user5Token}`, `xsrf-token=${user5Session.csrfToken}`]
        ...
        user6Cookies = [`_openresponse_session=${user6Token}`, `xsrf-token=${user6Session.csrfToken}`]
