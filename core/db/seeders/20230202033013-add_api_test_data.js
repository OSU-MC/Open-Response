...
module.exports = {
  async up(queryInterface, Sequelize) {
	...
	*/
    ...
    const teacherOnlyUser = await queryInterface.bulkInsert("Users", [
      {
        firstName: "Teacher",
        lastName: "User",
    ...
    const studentOnlyUser = await queryInterface.bulkInsert("Users", [
      {
        firstName: "Student",
        lastName: "User",
    ...
    const studentUserNoCourses = await queryInterface.bulkInsert("Users", [
      {
        firstName: "No",
        lastName: "Courses",
	...
	*/
    ...
    const course1 = await queryInterface.bulkInsert("Courses", [
      {
        name: "Main Course",
