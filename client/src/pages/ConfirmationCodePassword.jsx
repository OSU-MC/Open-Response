      ...
      <div className="leftContainer">
        <div className="welcomeBox">
          <span className="classroomLink">
            ...
            <img
              className="classroomIcon"
              src="classroomIcon.png"
              alt="Classroom Icon"
            />
            {VITE_NAME}
          </span>
      ...
      <div className="rightContainer">
        <div className="resetpassword">
          <div className="confirmationCodeDivContainer">
            ...
            <p>
              Please enter your email address related to your account.
              <br />
              We will send a confirmation code to that email.
            </p>
            <br />
            <form onSubmit={(event) => event.preventDefault()}>
              ...
              <div>
                <button
                  type="submit"
                  className="submitButtonReset"
                  onClick={emailObjectStaging}
                >
                  Get Code
                </button>
              </div>
